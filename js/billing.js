var ItemSize, ItemValue, ItemQuantity;
var priceToPay;

// Place order Function
function placeOrder() {
    ItemSize = localStorage.getItem("ItemSize");
    ItemValue = Number(localStorage.getItem("ItemValue"));
    ItemQuantity = Number(localStorage.getItem("ItemQuantity"));

    priceToPay = ItemValue * ItemQuantity;

    printedText = `You have to pay for ${ItemSize} size, ${ItemQuantity} Quantity, ${ItemValue} Itemvalue : ${priceToPay} Rs price`;
    alert(printedText);
